...
relig_income %>% 
  pivot_longer(-religion, #not moving religion
             names_to = "income", #column names to new variable called income
             values_to = "total") #values to new variable called total
```
...
Each day has its own column instead of being saved as data within a column.
